...
export interface Translations {
	...
	errNotConfiguredDesc: string;
	errAuth: string;
	errAuthDesc: string;
	errNotFound: string;
	errNotFoundDesc: (key: string) => string;
	errUnexpected: string;
	errApi: (msg: string) => string;
}
...
const en: Translations = {
	...
	errNotConfiguredDesc: 'Open Settings → CrystalBear and enter your Jira URL, email secret, and API token secret.',
	errAuth: 'Authentication failed',
	errAuthDesc: 'Your credentials were rejected by Jira. Check your email and API token in Settings → CrystalBear.',
	errNotFound: 'Not found',
	errNotFoundDesc: (key) => `'${key}' does not exist or you don't have permission to view it.`,
	errUnexpected: 'Something went wrong',
	errApi: (msg) => `Jira returned an error: ${msg}`,
};
...
const de: Translations = {
	...
	errNotConfigured: 'Nicht konfiguriert',
	errNotConfiguredDesc: 'Öffne Einstellungen → CrystalBear und gib deine Jira-URL, E-Mail-Secret und API-Token-Secret ein.',
	errAuth: 'Authentifizierung fehlgeschlagen',
	errAuthDesc: 'Deine Zugangsdaten wurden von Jira abgelehnt. Prüfe E-Mail und API-Token unter Einstellungen → CrystalBear.',
	errNotFound: 'Nicht gefunden',
	errNotFoundDesc: (key) => `'${key}' existiert nicht oder du hast keine Berechtigung, es anzuzeigen.`,
	errUnexpected: 'Etwas ist schiefgelaufen',
	errApi: (msg) => `Jira hat einen Fehler zurückgegeben: ${msg}`,
};
